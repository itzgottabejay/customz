...
echo "----"
echo "Also comment out Backports as we're not worried about bleeding edge features"
echo "----"
...
sudo apt-get install -y flameshot feh python3-pip unclutter cargo imagemagick jq
